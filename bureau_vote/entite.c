...
int Tauxobs(char filename2[],float *taux_obse,float *taux_obsn)
{
    observateur obs;
    int nbr_obsn=0;
    int nbr_obse=0;
...
*taux_obse=(nbr_obse/nbr_obs)*100;
*taux_obsn=(nbr_obsn/nbr_obs)*100;
fclose(f);
return 0;}
